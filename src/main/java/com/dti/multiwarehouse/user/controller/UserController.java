...
public class UserController {
    ...
    private void sendVerificationEmail(String email) {
        ...
        String verificationLink = "https://dev.alphamarch.shop/email-verification?email=" + encodedEmail + "&token=" + token;
    ...
    public ResponseEntity<?> verifyEmail(@RequestParam("token") String token, HttpSession session) {
        try {
            ...
            String redirectUrl = session.getAttribute("user") != null ? "https://dev.alphamarch.shop/my-profile" : "https://dev.alphamarch.shop";
...
//        String encodedToken = URLEncoder.encode(token, StandardCharsets.UTF_8);
        ...
        String resetLink = "https://dev.alphamarch.shop/reset-password/confirmation?email="+encodedEmail+"&token="+token;
        SimpleMailMessage mailMessage = new SimpleMailMessage();
